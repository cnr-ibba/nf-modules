...
process BAMADDRG {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/bamaddrg:9baba65f88228e55639689a3cea38dd150e6284f--h4dc6686_2':
    ...
    "${task.process}":
        bamaddrg: \$(echo \$(samtools --version 2>&1) | sed 's/^.*samtools //; s/Using.*\$//' ))
    END_VERSIONS
    """
}
